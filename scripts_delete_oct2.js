...
(async () => {
  ...
  // Find all entries for October 2nd
  ...
  console.log(`Found ${entries.length} entries on October 2nd:`);
  entries.forEach((e, i) => {
  ...
  if (entries.length > 0) {
    ...
    console.log(`\n✅ Deleted ${entries.length} entries from October 2nd`);
  } else {
    console.log("\n⚠️ No entries found for October 2nd");
  }
